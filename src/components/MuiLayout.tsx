...
export const MuiLayout = () => {
 ...
 <Box display='flex' height='100px' width='100px' bgcolor='success.light' p={2}> </Box>
   ...
   <Grid container my={4} rowSpacing={2} columnSpacing={1}>
    <Grid item xs={6}>
        <Box bgcolor='primary.light' p={3} > Item 1 </Box>
    </Grid>
    <Grid item xs={6}>
        <Box bgcolor='primary.light' p={9} > Item 2 </Box>
    </Grid>
    <Grid item xs={6}>
        <Box bgcolor='primary.light' p={9} > Item 3  </Box>
    </Grid>
    <Grid item xs={6}>
         <Box bgcolor='primary.light' p={3} >Item 4  </Box>
    </Grid>
   </Grid>
   </Paper>
  )
