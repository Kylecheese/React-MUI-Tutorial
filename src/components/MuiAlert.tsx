...
export const MuiAlert = () => {
  return (
    <Stack spacing={2}>
        ...
        <Alert  variant='outlined' severity='error' onClose={() => alert('Close alert')}> This is an error alert </Alert>
        ...
        <Alert  variant= 'filled'  severity='error'> <AlertTitle> Error </AlertTitle> This is an error alert  </Alert>
        ...
        }><AlertTitle> Success </AlertTitle>   This is an success alert </Alert>    
    </Stack>
  )
}
